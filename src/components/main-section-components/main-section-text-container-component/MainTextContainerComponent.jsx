...
export default function MainTextContainerComponent() {
    ...
    return (
        <div className="main-section-text-container">
            ...
            <p className="desc">{translate("Consult", language)} <b>{translate("now", language)}</b> {translate("or", language)} <b>{translate("by_previous_appointment", language)}</b> {translate("from_your", language)} {translate("computer", language)} {translate("or", language)} {translate("by_using_our_application", language)}, {translate("available_in", language)} <span className="highlight-blue">App Store</span> {translate("and", language)} <span className="highlight-blue">Google Play</span></p>
